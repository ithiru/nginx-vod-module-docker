...
```
% docker run -p 3030:80 -v $PWD/videos:/opt/static/videos -v $PWD/nginx.conf:/usr/local/openresty/nginx/conf/nginx.conf ithiru/resty-vod
```
...
- Hello via Lua: http://localhost:3030/hello
